package com.kristal.library.appbase.recyclerview.snaphelper
...
/**
 * Created by Kristal on 11/06/2017.
 */

class GravitySnapHelper @SuppressLint("RtlHardcoded") constructor(private var gravity: Int) : LinearSnapHelper() {
  ...
  @Throws(IllegalStateException::class) override fun attachToRecyclerView(recyclerView: RecyclerView?) {
    if (recyclerView != null) {
      //            isSupportRtL = recyclerView.context.resources.getBoolean(R.bool.is_rtl)
    }
